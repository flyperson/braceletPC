...
$sql_s = "SELECT usergroup,SUM(step_count) AS step_count,SUM(score) AS score,SUM(calorie) AS calorie,MAX(record_date) AS record_date,SUM(`score`)/COUNT(`usergroup`) AS average,COUNT(`usergroup`) AS groupnum FROM allstepcount WHERE record_date BETWEEN '".$startdate."' AND '".$enddate."' GROUP BY usergroup,record_date  ORDER BY usergroup;";	
...
$name = "分组步数数据".$startdate."_".$enddate.".xlsx"; 
