...
(function() {
    ...
    // Toggle Left Menu2222222
   jQuery('.menu-list2 > a').click(function() {
      ...
      if(!jQuery('body').hasClass('left-side-collapsed')) {
         if(sub.is(':visible')) {
            sub.slideUp(200, function(){
               parent.removeClass('nav-active2');
               jQuery('.main-content').css({height: ''});
               mainContentHeightAdjust();
            });
         } else {
            visibleSubMenuClose();
            parent.addClass('nav-active2');
   ...
   function visibleSubMenuClose() {
      jQuery('.menu-list2').each(function() {
         var t = jQuery(this);
         if(t.hasClass('nav-active2')) {
            t.find('> ul').slideUp(200, function(){
               t.removeClass('nav-active2');
            });
         }
      });
   }
